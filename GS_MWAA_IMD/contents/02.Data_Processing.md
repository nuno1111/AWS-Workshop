...
3. 좌측에 redshiftcluster-ID 우클릭 후 Edit Connection 클릭

![redshift_query_editor_02](../images/02-05.redhisft_query_editor_02.png)

4. redshiftcluster-ID 는 복사하여 별도 메모장에 저장
...
7. airflow UI 접속 후 Admin > Connections 이동 후 "redshift_default" 정보 수정
8. user에 반드시 admin 입력
